...
MASTER="${MASTER}"
MASTERPUBLICIPHOSTNAME="${MASTERPUBLICIPHOSTNAME}"
MASTERPUBLICIPADDRESS="${MASTERPUBLICIPADDRESS}"
INFRA="${INFRA}"
NODE="${NODE}"
NODECOUNT="${NODECOUNT}"
...
SAKEY1="${SAKEY1}"
OANSIBLEURL="${OANSIBLEURL}"
OANSIBLEBRANCH="${OANSIBLEBRANCH}"
